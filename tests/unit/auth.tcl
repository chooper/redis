...
start_server {tags {"auth"} overrides {requirepass {foo bar}}} {
    ...
    test {We can CONFIG GET passwords} {
...
# CONFIG SET rejects bad commands
start_server {tags {"auth"}} {
...
# Long valid password check
start_server {tags {"auth"}} {
    test {CONFIG SET allows multiple passwords of REDIS_AUTHPASS_MAX_LEN (512 chars)} {
        r config set requirepass " "
    } {OK}
}

# Lots of long valid passwords
start_server {tags {"auth"}} {
    test {CONFIG SET allows REQUIREPASS_MAX passwords of AUTHPASS_MAX_LEN size} {
        # Sorry, but I don't know tcl enough to make this cleaner :-)
